...
|---------|-------|--------|----------|------------|---------|-----------|
| `10-A` | Schema Extension (`TopicExpertise` source/confirmation/decay fields) | `TODO` | Sandeep | — | | |
| `10-B` | Standalone Expert Directory (FR-1) | `TODO` | Sandeep | `10-A` | | |
| `10-C` | Project-Scope Expertise (FR-2) | `TODO` | Sandeep | `10-A` | | |
| `10-D` | Expertise Confirmation / Correction (FR-3) | `TODO` | Sandeep | `10-A`, `10-B` | | |
| `10-E` | Recency-Weighted Scoring (FR-4) | `TODO` | Sandeep | `10-A` | | |
| `10-F` | RBAC Integration Test — closes Rank 8's `9-G` (FR-5) | `TODO` | Sandeep | `10-C` | | |
| `10-G` | Expertise on Document/Topic Pages (FR-6) | `TODO` | Sandeep | `10-B` | | |
| `10-H` | Integration Validation | `TODO` | Sandeep | `10-D`, `10-E`, `10-F`, `10-G` | | |
